...
parser.add_argument("--tasks", type=str, nargs='+', default=None, help='subset of tasks to evaluate')
...
def main():
    ...
    if eval_results:
        ...
        print("No tasks were evaluated (no matching prediction files found).")
