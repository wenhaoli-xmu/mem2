...
def model_forward(
    ...
    for decoder_layer in self.layers[: self.config.num_hidden_layers]:
        hidden_states, ret_scores, pre_attn_states = decoder_layer(
            hidden_states,
            position_embeddings=self.position_embeddings,
            **kwargs)
        attentions.append(ret_scores)
        if return_hidden_states:
            middle_hidden_states.append(pre_attn_states)
...
def layer_forward(
    ...
    **kwargs: Unpack[TransformersKwargs],
    ...
    pre_attn_states = hidden_states.cpu().clone()
    ...
    hidden_states = residual + hidden_states
    return hidden_states, ret_scores, pre_attn_states
