...
__global__ void attn_k8_q32_kernel_unified(
...
torch::Tensor attn_k8_q32(torch::Tensor q_hash, torch::Tensor k_hash, torch::Tensor kv_length) {
    ...
    attn_k8_q32_kernel_unified<<<gridDim, blockDim, shared_mem_size, at::cuda::getCurrentCUDAStream()>>>(
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    m.def("attn_k8_q32", &attn_k8_q32, "Attention kernel for k8 q32",
